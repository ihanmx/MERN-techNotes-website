...
const NewUserForm = () => {
  ...
  const onSaveUserClicked = async (e) => {
    ...
    try {
      ...
      //   The effect was reacting to a flag (isSuccess) set by the mutation — but the mutation itself already returns a promise. Awaiting it (+ .unwrap()
      setUsername("");
      setPassword("");
      setRoles([]);
      navigate("/dash/users");
    } catch {
      // error is surfaced via the `error` state from the mutation hook
    }
  };
